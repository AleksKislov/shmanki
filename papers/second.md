...
2. Спроектирована реляционная схема базы данных с шестью основными таблицами. Использование типа JSONB для хранения массивов токенов и данных попыток устраняет необходимость дополнительных таблиц при сохранении возможности индексирования. Составные индексы обеспечивают выполнение ключевого запроса выборки карточек для сессии за O(log N + m) при любом размере базы данных.
